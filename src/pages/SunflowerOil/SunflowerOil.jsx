...
export const SunflowerOil = () => {
  return (
    <>
      ...
      <Container>
        <Description
          value="For several years of experience in cooperation with leading Ukrainian companies that produce sunflower oil,we have established ourselves as a reliable and trusted partner. Our team of experienced specialists makes every effort to ensure timely guaranteed supplies of sunflower oil. We are an export-oriented enterprise. All products of the enterprise are sold for export to EU countries. Our main buyers of sunflower oil are first-class international companies such as ALFA TRADING LIMITED, COFCO RESOURCES S.A., Louis Dreyfus Сommodites S.A., Glencore Grain BV., ADM Germany GmbH and others. A large number of manufacturers of products allow the sale of large volumes of products: – sunflower oil (refined deodorized frozen grade P) – 80,000 tons per year;– sunflower oil (raw, unrefined, first grade) – 100,000 tons per year.<br /> Shipment of finished products is possible by the following modes of transport: motor transport, railway transport, including oil loading in flexi-tanks. Loading of products in 40-foot containers installed on railway platforms."
          margin="40px 0 0 0"
        />
